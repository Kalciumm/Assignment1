...
void DefaultSceneLayer::_CreateScene()
{
	...
	//	Texture2D::Sptr    funny = ResourceManager::CreateAsset<Texture2D>("textures/moon.png");
		...
		Texture3D::Sptr lut = ResourceManager::CreateAsset<Texture3D>("luts/Ocean.CUBE");  
		Texture3D::Sptr lut2 = ResourceManager::CreateAsset<Texture3D>("luts/RIPANDTEAR.CUBE");
		Texture3D::Sptr lut3 = ResourceManager::CreateAsset<Texture3D>("luts/Funk.CUBE");
		// Configure the color correction LUTluts/
		scene->SetColorLUT(lut);
		scene->SetColorLUT(lut2);
		scene->SetColorLUT(lut3);
		...
		GameObject::Sptr foliageBox = scene->CreateGameObject("Foliage Box");
		{
			...
			box->GenerateMesh();
			foliageBox->Add<MovementComponent>();
			// Set and rotation position in the scene
			foliageBox->SetPostion(glm::vec3(-6.0f, -4.0f, 1.0f));
	
			RigidBody::Sptr physics = foliageBox->Add<RigidBody>(RigidBodyType::Dynamic);
